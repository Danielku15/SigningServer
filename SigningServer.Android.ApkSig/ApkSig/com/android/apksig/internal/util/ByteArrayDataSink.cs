...
namespace SigningServer.Android.Com.Android.Apksig.Internal.Util
{
    ...
    public class ByteArrayDataSink: SigningServer.Android.Com.Android.Apksig.Util.ReadableDataSink
    {
        ...
        public void Consume(SigningServer.Android.IO.ByteBuffer buf)
        {
            ...
            byte[] tmp = new byte[global::System.Math.Min(buf.Remaining(), SigningServer.Android.Com.Android.Apksig.Internal.Util.ByteArrayDataSink.MAX_READ_CHUNK_SIZE)];
        ...
        internal void EnsureAvailable(int minAvailable)
        {
            ...
            if (minCapacity > maxValue)
            {
                throw new global::System.IO.IOException("Required capacity too large: " + minCapacity + ", max: " + maxValue);
            }
            int doubleCurrentSize = (int)global::System.Math.Min(mArray.Length * 2L, maxValue);
            int newSize = (int)global::System.Math.Max(minCapacity, doubleCurrentSize);
