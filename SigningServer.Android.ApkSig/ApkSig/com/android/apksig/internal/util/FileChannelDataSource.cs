...
namespace SigningServer.Android.Com.Android.Apksig.Internal.Util
{
    ...
    public class FileChannelDataSource: SigningServer.Android.Com.Android.Apksig.Util.DataSource
    {
        ...
        public void Feed(long offset, long size, SigningServer.Android.Com.Android.Apksig.Util.DataSink sink)
        {
            ...
            long remaining = size;
            SigningServer.Android.IO.ByteBuffer buf = SigningServer.Android.IO.ByteBuffer.AllocateDirect((int)global::System.Math.Min(remaining, SigningServer.Android.Com.Android.Apksig.Internal.Util.FileChannelDataSource.MAX_READ_CHUNK_SIZE));
            while (remaining > 0)
            {
                long b = buf.Capacity();
                int chunkSize = (int)global::System.Math.Min(remaining, b);
