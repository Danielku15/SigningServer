...
{
    public abstract class ByteBufferSinkTestBase : DataSinkTestBase<ByteBufferSink>
    {
        private static readonly int START_POS = 100;
        ...
        protected override ByteBuffer
            getContents(ByteBufferSink dataSink)
        {
