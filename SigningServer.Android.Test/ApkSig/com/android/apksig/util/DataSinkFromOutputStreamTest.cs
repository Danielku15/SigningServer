...
namespace SigningServer.Android.Com.Android.Apksig.Util
{
    ...
    public class DataSinkFromOutputStreamTest: SigningServer.Android.Com.Android.Apksig.Util.DataSinkTestBase<Com.Android.Apksig.Internal.Util.OutputStreamDataSink>
    {
        ...
        {
            return SigningServer.Android.Com.Android.Apksig.Util.DataSinkTestBase.CloseableWithDataSink.Of((Com.Android.Apksig.Internal.Util.OutputStreamDataSink)Com.Android.Apksig.Util.DataSinks.AsDataSink(new SigningServer.Android.IO.ByteArrayOutputStream()));
        }
