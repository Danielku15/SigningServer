...
namespace SigningServer.Android.ApkSig.Apk
{
     ...
     * functionality.
     */
    public static class ApkUtilsLite
    {
        /**
        ...
        {
            Tuple<ByteBuffer, long> eocdAndOffsetInFile =
            ...
            ByteBuffer eocdBuf = eocdAndOffsetInFile.Item1;
            long eocdOffset = eocdAndOffsetInFile.Item2;
        ...
        private static readonly long APK_SIG_BLOCK_MAGIC_HI = 0x3234206b636f6c42L;
        private static readonly long APK_SIG_BLOCK_MAGIC_LO = 0x20676953204b5041L;
        private static readonly int APK_SIG_BLOCK_MIN_SIZE = 32;
     ...
     */
        public static ApkSigningBlock findApkSigningBlock(DataSource apk, ZipSections zipSections)
        {
            ...
            if ((apkSigBlockSizeInFooter < footer.capacity())
                || (apkSigBlockSizeInFooter > int.MaxValue - 8))
            {
                throw new ApkSigningBlockNotFoundException(
        ...
        {
            private readonly long mStartOffsetInApk;
            private readonly DataSource mContents;
        ...
        public static byte[] computeSha256DigestBytes(byte[] data)
        {
            ...
            {
                return messageDigest.ComputeHash(data);
            }
        }
    }
}