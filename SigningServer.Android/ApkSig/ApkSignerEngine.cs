...
namespace SigningServer.Android.ApkSig
{
    ...
    internal interface ApkSignerEngine : IDisposable
    {
         ...
         */
        ISet<string> initWith(byte[] manifestBytes, ISet<string> entryNames);
         ...
         * @throws IllegalStateException if this engine is closed
         */
        InspectJarEntryRequest outputJarEntry(string entryName);
         ...
         */
        void signV4(DataSource data, FileInfo outputFile, bool ignoreFailures);

        /**
         * Checks if the signing configuration provided to the engine is capable of creating a
         * SourceStamp.
         */
        bool isEligibleForSourceStamp();
    ...
    interface OutputJarSignatureRequest
    {
         ...
         */
        List<OutputJarSignatureRequestJarEntry> getAdditionalJarEntries();
    ...
    /**
         * JAR entry.
         */
    public class OutputJarSignatureRequestJarEntry
    {
         ...
         */
        public OutputJarSignatureRequestJarEntry(String name, byte[] data)
        {
            mName = name;
