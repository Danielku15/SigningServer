 ...
 */
     ...
     * {@code params}.
     */
        public ApkVerificationIssue(string format, params object[] @params)
        {
            mIssueId = -1;
            mFormat = format;
            mParams = @params;
     ...
     * params}.
     */
        public ApkVerificationIssue(int issueId, params object[] @params)
        {
            mIssueId = issueId;
            mFormat = null;
            mParams = @params;
     ...
     */
        ...
        public override string ToString()
        {
            ...
            var result = new StringBuilder("mIssueId: ");
            result.Append(mIssueId);
