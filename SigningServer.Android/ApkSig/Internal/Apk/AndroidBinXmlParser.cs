...
namespace SigningServer.Android.ApkSig.Internal.Apk
{
    ...
    public class AndroidBinXmlParser
    {
        ...
        private readonly ByteBuffer mXml;
     ...
     */
        public AndroidBinXmlParser(ByteBuffer xml)
        {
 ...
 *
 * @throws IndexOutOfRangeException if the index is out of range or the current event is not a
 ...
 */
        ...
        /**
 * Returns the bool value of the specified attribute of the current element. See
 * {@code VALUE_TYPE_...} constants.
 *
 * @throws IndexOutOfRangeException if the index is out of range or the current event is not a
 *         {@code start element} event.
 * @throws XmlParserException if a parsing error is occurred
 */
        public bool getAttributeboolValue(int index)
        {
            return getAttribute(index).getboolValue();
        }
 ...
 */
        ...
        private Attribute getAttribute(int index)
        {
            ...
            return mCurrentElementAttributes[index];
        }
 ...
 */
        ...
        private void parseCurrentElementAttributesIfNotParsed()
        {
            ...
            mCurrentElementAttributes = new List<Attribute>(mCurrentElementAttributeCount);
        ...
        private class Attribute
        {
            ...
            private readonly int mValueData;
            private readonly StringPool mStringPool;
            ...
            public bool getboolValue()
            {
                switch (mValueType)
                {
                    ...
                    default:
                        throw new XmlParserException(
                            "Cannot coerce to bool: value type " + mValueType);
                }
            }
     ...
     */
        private class Chunk
        {
            ...
            public const int TYPE_RES_XML = 3;
            ...
            private readonly ByteBuffer mContents;
         ...
         */
            public static Chunk get(ByteBuffer input)
            {
     ...
     */
        private class StringPool
        {
            ...
            private readonly int mStringCount;
            private readonly bool mUtf8Encoded;
            private readonly Dictionary<int, String> mCachedStrings = new Dictionary<int, string>();
 ...
 */
            public String getString(long index)
            {
                ...
                int idx = (int)index;
                if (mCachedStrings.TryGetValue(idx, out var result))
                {
                    return result;
                }
            ...
            private static String getLengthPrefixedUtf16EncodedString(ByteBuffer encoded)
            {
                ...
                return Encoding.Unicode.GetString(arr, arrOffset, lengthBytes);
                ;
            }
            ...
            private static String getLengthPrefixedUtf8EncodedString(ByteBuffer encoded)
            {
                ...
                return Encoding.UTF8.GetString(arr, arrOffset, lengthBytes);
            }
        }
     ...
     */
        ...
        {
            private readonly ByteBuffer mChunkContents;
            private readonly int mEntryCount;
