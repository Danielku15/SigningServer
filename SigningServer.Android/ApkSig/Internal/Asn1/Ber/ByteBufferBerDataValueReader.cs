...
namespace SigningServer.Android.ApkSig.Internal.Asn1.Ber
{
     ...
     */
    public class ByteBufferBerDataValueReader : BerDataValueReader
    {
        private readonly ByteBuffer mBuf;
        ...
        public BerDataValue readDataValue()
        {
            ...
            bool constructed = BerEncoding.isConstructed(firstIdentifierByte);
            if (!mBuf.hasRemaining())
            {
        ...
        private int readTagNumber(byte firstIdentifierByte)
        {
        ...
        private int readLongFormLength(int firstLengthByte)
        {
        ...
        private void skipDefiniteLengthContents(int contentsLength)
        {
