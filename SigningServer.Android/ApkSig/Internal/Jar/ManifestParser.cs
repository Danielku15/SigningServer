...
namespace SigningServer.Android.ApkSig.Internal.Jar
{
    ...
    {
        private readonly byte[] mManifest;
        private int mOffset;
        ...
        private static Attribute parseAttr(String attr)
        {
            ...
            int delimiterIndex = attr.IndexOf(": ", StringComparison.OrdinalIgnoreCase);
            if (delimiterIndex == -1)
            {
     ...
     */
        ...
        private static byte[] concat(byte[] arr1, byte[] arr2, int offset2, int length2)
        {
            ...
            Array.Copy(arr2, offset2, result, arr1.Length, length2);
            return result;
        }
     ...
     */
        private byte[] readLine()
        {
            ...
            var copy = new byte[newlineStartOffset - startOffset];
            Array.Copy(mManifest, startOffset, copy, 0, copy.Length);
            return copy;
        }
        ...
        {
            private readonly int mStartOffset;
            private readonly int mSizeBytes;
            private readonly String mName;
            private readonly List<Attribute> mAttributes;
            ...
            public Section(int startOffset, int sizeBytes, List<Attribute> attrs)
            {
                ...
                if (attrs.Count != 0)
                {
                    ...
                    if ("Name".Equals(firstAttr.getName(), StringComparison.OrdinalIgnoreCase))
                    {
                ...
                mName = sectionName;
                mAttributes = new List<Attribute>(attrs);
            }
         ...
         */
            public String getAttributeValue(String name)
            {
                ...
                {
                    if (attr.getName().Equals(name, StringComparison.OrdinalIgnoreCase))
                    {
