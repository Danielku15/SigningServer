...
namespace SigningServer.Android.ApkSig.Internal.Oid
{
    public static class OidConstants
    {
        ...
        public static void addSupportedSigAlg(
            ...
            params InclusiveIntRange[] supportedApiLevels)
        {
        ...
        public static List<InclusiveIntRange> getSigAlgSupportedApiLevels(
            ...
            string signatureAlgorithmOid)
        {
            if (SUPPORTED_SIG_ALG_OIDS.TryGetValue(digestAlgorithmOid + "with" + signatureAlgorithmOid, out var levels))
            {
                return levels;
            }
        ...
        {
            private static readonly Dictionary<string, string> OID_TO_USER_FRIENDLY_NAME =
                new Dictionary<string, string>();

            static OidToUserFriendlyNameMapper()
            {
                OID_TO_USER_FRIENDLY_NAME.Add(OID_DIGEST_MD5, "MD5");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_DIGEST_SHA1, "SHA-1");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_DIGEST_SHA224, "SHA-224");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_DIGEST_SHA256, "SHA-256");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_DIGEST_SHA384, "SHA-384");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_DIGEST_SHA512, "SHA-512");

                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_RSA, "RSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_MD5_WITH_RSA, "MD5 with RSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA1_WITH_RSA, "SHA-1 with RSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA224_WITH_RSA, "SHA-224 with RSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA256_WITH_RSA, "SHA-256 with RSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA384_WITH_RSA, "SHA-384 with RSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA512_WITH_RSA, "SHA-512 with RSA");


                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_DSA, "DSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA1_WITH_DSA, "SHA-1 with DSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA224_WITH_DSA, "SHA-224 with DSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA256_WITH_DSA, "SHA-256 with DSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA384_WITH_DSA, "SHA-384 with DSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA512_WITH_DSA, "SHA-512 with DSA");

                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_EC_PUBLIC_KEY, "ECDSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA1_WITH_ECDSA, "SHA-1 with ECDSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA224_WITH_ECDSA, "SHA-224 with ECDSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA256_WITH_ECDSA, "SHA-256 with ECDSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA384_WITH_ECDSA, "SHA-384 with ECDSA");
                OID_TO_USER_FRIENDLY_NAME.Add(OID_SIG_SHA512_WITH_ECDSA, "SHA-512 with ECDSA");
            }

            public static string getUserFriendlyNameForOid(string oid)
            {
                if (OID_TO_USER_FRIENDLY_NAME.TryGetValue(oid, out var friendlyName))
                {
                    return friendlyName;
                }
        ...
        public static readonly Dictionary<string, string> OID_TO_JCA_DIGEST_ALG = new Dictionary<string, string>
        {
            [OID_DIGEST_MD5] = "MD5",
        ...
        public static readonly Dictionary<string, string> OID_TO_JCA_SIGNATURE_ALG = new Dictionary<string, string>
        {
