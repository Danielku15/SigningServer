 ...
 */
    public class OutputStreamDataSink : DataSink
    {
        private static readonly int MAX_READ_CHUNK_SIZE = 65536;

        private readonly Stream mOut;

        /**
     * Constructs a new {@code OutputStreamDataSink} which outputs received data into the provided
     * {@link OutputStream}.
     */
        public OutputStreamDataSink(Stream @out)
        {
            mOut = @out ?? throw new ArgumentNullException(nameof(@out));
        }
