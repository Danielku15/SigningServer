...
namespace SigningServer.Android.ApkSig.Internal.Zip
{
    ...
    {
        private static readonly int CD_RECORD_COUNT_ON_DISK_OFFSET = 8;
        private static readonly int CD_RECORD_COUNT_TOTAL_OFFSET = 10;
        private static readonly int CD_SIZE_OFFSET = 12;
        private static readonly int CD_OFFSET_OFFSET = 16;
