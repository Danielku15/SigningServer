...
namespace SigningServer.Android.ApkSig.Zip
{
    /**
    ...
    {
        private readonly long mCentralDirectoryOffset;
        private readonly long mCentralDirectorySizeBytes;
        private readonly int mCentralDirectoryRecordCount;
        private readonly long mEocdOffset;
        private readonly ByteBuffer mEocd;
