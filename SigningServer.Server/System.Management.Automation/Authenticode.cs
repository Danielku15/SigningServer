...
namespace System.Management.Automation
{
    ...
    internal static class SignatureHelper
    {
        ...
        /// </summary>
        private static readonly Logger s_tracer = LogManager.GetCurrentClassLogger();
...
#pragma warning restore 56523
                ...
                if (!result)
                {
                    ...
                    else
                    {
                        ...
                        s_tracer.Error("CryptUIWizDigitalSign: failed: {0:x}",
                                          error);
                    }
                }
                    ...
                    try
                    {
                        ...
                        if (Utils.Succeeded(hresult))
                        {
                            ...
                            if (!Signature.CatalogApiAvailable.HasValue)
                            {
                                ...
                                if (signature.Status != SignatureStatus.Valid && File.Exists(productFile))
                                {
        ...
        private static Signature GetSignatureFromWinVerifyTrust(string fileName, string fileContent)
        {
            ...
            try
            {
                ...
                {
                    s_tracer.Error("GetWinTrustData failed: {0:x}", error);
                }
                ...
                if (error != Win32Errors.NO_ERROR)
                {
                    s_tracer.Error("DestroyWinTrustDataStruct failed: {0:x}", error);
                }
            }
...
#pragma warning restore 56523
        ...
        private static Signature GetSignatureFromWintrustData(
            ...
            NativeMethods.WINTRUST_DATA wtd)
        {
            s_tracer.Error("GetSignatureFromWintrustData: error: {0}", error);
            ...
            System.Diagnostics.Debug.Assert(error != 0 || signature != null, "GetSignatureFromWintrustData: general crypto failure");
