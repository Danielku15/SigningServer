...
[AttributeUsage(AttributeTargets.Method | AttributeTargets.Class | AttributeTargets.Struct, AllowMultiple = true,
    Inherited = false)]
public class DeploymentItemAttribute : Attribute, IApplyToContext
{
    ...
    void IApplyToContext.ApplyToContext(NUnit.Framework.Internal.TestExecutionContext context)
    {
